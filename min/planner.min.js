...
function iCalDateToISOString(icalDate){let year=icalDate.slice(0,4);let month=parseInt(icalDate.slice(4,6));let day=icalDate.slice(6,8);let dateObject;if(icalDate.indexOf("T")!==-1){hour=icalDate.slice(9,11);min=icalDate.slice(11,13);sec=icalDate.slice(13,15);dateObject=new Date(year,month-1,day,hour,min,sec);}
