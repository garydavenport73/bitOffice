...
document.getElementById('last-calculator-expression').innerHTML="Evaluated: "+sanitizedValue;let result='';try{result=evalReplaceFunction(sanitizedValue);}catch(error){result=error;}
calcInput.value=result;}
function evalReplaceFunction(str){return Function("'use strict'; return ("+str+")")();}